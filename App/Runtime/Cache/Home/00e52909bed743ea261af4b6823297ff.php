...
<div id="slider" class="mui-slider">
	<div class="mui-slider-group mui-slider-loop">
		...
		<div class="mui-slider-item mui-slider-item-duplicate">
			<a href="#">
				<img src="http://localhost/zlApp/Style/mui/images/yuantiao.jpg">
				<p class="mui-slider-title">静静看这世界</p>
			</a>
		</div>
		<div class="mui-slider-item">
			<a href="#">
				<img src="http://localhost/zlApp/Style/mui/images/shuijiao.jpg">
				<p class="mui-slider-title">幸福就是可以一起睡觉</p>
			</a>
		</div>
		<div class="mui-slider-item">
			<a href="#">
				<img src="http://localhost/zlApp/Style/mui/images/muwu.jpg">
				<p class="mui-slider-title">想要一间这样的木屋，静静的喝咖啡</p>
			</a>
		</div>
		<div class="mui-slider-item">
			<a href="#">
				<img src="http://localhost/zlApp/Style/mui/images/cbd.jpg">
...
<div>
	...
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><li class="mui-table-view-cell mui-media">
			<a href="course/index?cid=<?php echo ($l["id"]); ?>">
		...
		<!-- <li class="mui-table-view-cell mui-media">
			<a href="course/index">
				<img class="mui-media-object mui-pull-left" src="http://localhost/zlApp/Style/mui/images/muwu.jpg">
				<div class="mui-media-body">
					木屋
		...
		<li class="mui-table-view-cell mui-media">
			<a href="course/index">
				<img class="mui-media-object mui-pull-left" src="http://localhost/zlApp/Style/mui/images/cbd.jpg">
				<div class="mui-media-body">
					CBD
...
<div style="margin-top: 60px">
	<nav class="mui-bar mui-bar-tab">
		<a class="home-a" href="subscribe/subscribed">
			order
		</a>
	</nav>
</div>
